...
from .models import Root, Child, Uncle, Sibling, GrandChild, Aunt, CounselingUncle, EstrangedChild, PsychoChild, AdoptedChild
from milkman.dairy import milkman, MilkTruck
from milkman.generators import email_generator, random_choice_iterator, random_string, random_float, random_ipaddress_maker, random_comma_seperated_integer_maker, random_time_string_maker
...
class ModelTest(unittest.TestCase):
    ...
    def test_related_explicit_values(self):
        ...
        grandchild = milkman.deliver(
            GrandChild, parent__name='foo', parent__root__my_char='bar')
