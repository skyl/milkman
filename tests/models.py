...
class Root(models.Model):
    ...
    my_commaseperatedinteger = models.CommaSeparatedIntegerField(
        blank=False, null=False, max_length=12)
    ...
    my_decimal = models.DecimalField(
        blank=False, null=False, decimal_places=2, max_digits=4)
    ...
    my_positivesmallinteger = models.PositiveSmallIntegerField(
    ...
    my_string = models.CharField(max_length=10, blank=True, null=True)
